...
const projects = [

	{
		...
		github: 'https://github.com/bhargavi374/CarRentals-react.git',
		description: "CARRENTALS is a MERN stack project developed using Vite. It's a car rental website that provides an online platform for users to rent cars for personal or business use. The website offers features for searching, comparing, and reserving cars.",
		image: Ataa
	},
	{
		name: 'SoKo Number',
		...
		<div className={style.app}>
			...
			<div id='Home' className={style.home}>
				...
				<div className={style["contact-nav"]}>
					<a className={style.github} target="_blank" href='https://github.com/bhargavi374' >
						<AiFillGithub size="30px" color='black' />
					</a>
					<a className={style.linkedin} target="_blank" href='https://www.linkedin.com/in/bhargavi-nareddy-423526237' >
						<AiFillLinkedin size="30px" color='black' />
					</a>
					<a className={style.gmail} target="_blank" href="mailto:nareddybhargavi47@gmail.com?subject=SendMail&body=Description" >
				...
				<div className={style.container}>
					<div className={style["footer-info"]}>
						...
						<div className={style.social}>
							<h3>Social</h3>
							<div className="">
								<a className={style.git} target="_blank" href='https://github.com/bhargavi374' >
